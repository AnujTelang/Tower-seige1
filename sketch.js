...
function setup() {
    ...
    target1=new targets(400,190,30,30);
    target2=new targets(370,220,30,30);
    target3=new targets(400,220,30,30);
    target4=new targets(430,220,30,30);
    target5=new targets(340,250,30,30);
    target6=new targets(370,250,30,30);
    target7=new targets(400,250,30,30);
    target8=new targets(430,250,30,30);
    target9=new targets(460,250,30,30);

    target10=new targets(800,130,30,30);
    fill("aquamarine");
    target11=new targets(830,160,30,30);
    target12=new targets(830,130,30,30);
    target13=new targets(830,100,30,30);
    target14=new targets(860,70,30,30);
    target15=new targets(860,100,30,30);
    target16=new targets(860,130,30,30);
    target17=new targets(800,160,30,30);
    target18=new targets(800,190,30,30);
